        ...
        <div className="hidden md:flex space-x-8 items-center">
          {navItems.map((item, index) => (
            <motion.button
              ...
              whileHover={{ y: -2 }}
              className={`relative text-sm font-medium transition-all duration-200 cursor-pointer px-3 py-2 rounded-lg ${
          ...
          <div className="px-6 py-4 space-y-4">
            {navItems.map((item, index) => (
              <motion.button
                ...
                whileHover={{ x: 5 }}
                className={`relative block w-full text-left text-sm font-medium transition-all duration-200 py-3 px-4 rounded-lg ${
                  activeSection === item.id
                    ? "text-primary bg-primary/10"
                    : "text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary hover:bg-primary/5"
                }`}
